            ...
            <div class="card-body">
                <h4 class="mt-0 header-title">Client Details</h4>
                    <div class="form-group">
                        <a href="client-agent" class="waves-effect">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @foreach($clnt as $cl)
                                                <tr>
                                                    <th>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"  class="btn btn-info btn-lg">   
                                                                ...
                                                                <a href= {{ "client-mod/".$cl->id }}> Edit </a></button>  
                                                                <button class="dropdown-item" type="button"> <i class="fas fa-ban"></i> 
                                                                <a href= {{ "client-detail/".$cl->id }}>Inactive </a></button>
                                                                <button class="dropdown-item" type="button">Client Limit</button>
                                                    ...
                                                    <td>{{$cl->id}}</td>
                                                    <td>{{$cl->client_code}}</td>
                                                    <td>{{$cl->client_name}}</td>
                                                    <td>{{$cl->agent_name}}</td>
                                                    <td>{{$cl->client_contact_num}}</td>
                                                    <td>{{$cl->client_curr_limit}}</td>                                                        
                                                    <td>{{$cl->client_share}}</td> 
                                                    <td>{{$cl->client_mob_share}}</td> 
                                                    <td>{{$cl->client_sess_com}}</td>
                                                    <td>{{$cl->client_match_com}}</td>                                                 
                                                    <td>{{$cl->client_status}}</td>
