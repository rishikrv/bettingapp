...
@section('breadcrumb')
<div class="col-sm-6">
                                    <h4 class="page-title">Client Ledger</h4>
                                    
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Ledger</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Client Ledger</a></li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Client Ledger</h4>
                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light">Show
                                                            </button>
                                                        </div>
                                                    </div>
