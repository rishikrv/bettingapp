...
<form method="POST" action="http://ezmata.com/11bett/betapi/sesBet.php" accept-charset="UTF-8" id="myForm">
    <input name="userid" type="hidden" value="">
    <input id="rate" name="rate" type="hidden" value="">
    <input id="mode" name="mode" type="hidden" value="">
    <input id="match_code" name="match_code" type="hidden" value="">
    ...
    <input id="sessionme" name="sessionme" type="hidden" value="ferer r tt">
                        ...
                        <tr>
                            <td align="left" valign="top">
                                ...
                                <table id="MatchBets" width="100%" border="0" cellpadding="2" cellspacing="2">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td height="35" align="center" valign="middle" bgcolor="#FFF" class="FontTextBlue" style="vertical-align:middle">LIONS : <span style="color: #2b2bf5;margin: 10px">0</span></td>
                                        ...
                                        <tr>
                                            <td height="35" align="center" valign="middle" bgcolor="#FFF" class="FontTextBlue" style="vertical-align:middle">WARRIORS : <span style="color: #2b2bf5;margin: 10px">0</span></td>
...
<script>
    ...
    function getData() {
        ...
        let url = 'http://207.180.200.148:1213/api/v2/791';
        ...
        $.each(response, function(index, data) {
            ...
            var $tr = $('<tr>').append(
                $('<td height="35" align="center" valign="middle" bgcolor="#FFF" class="textTeamHead"\n' +
                    ...
                    '                                                                   value="' + data
                    .SessionName + '" class="ButtonSess"/></td>'),
