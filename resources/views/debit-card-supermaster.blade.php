...
@section('breadcrumb')
<div class="col-sm-6">
                                    <h4 class="page-title">Super Master Ledger</h4>

                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Ledger</a></li>
                                        <li class="breadcrumb-item"><a href="agent.php">Super Master Ledger</a></li>
        ...
        <!-- Begin page -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Super Master Ledger</h4>
