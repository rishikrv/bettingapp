...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card card-body text-center ">
            ...
            <p class="">Declared :No</p>
            <p class="card-text">Won By : {{ $matchdata->won_by}}</p>
            <a href="match/{{ $matchdata->m_id}}?matchid={{ $matchdata->m_id}}" class="btn btn-warning waves-effect waves-light">Enter in match</a>
...
<!-- <script>
                            ...
                            document.getElementById("card1").addEventListerner("",)
                        </script> -->
